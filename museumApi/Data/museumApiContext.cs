...
{
    public class museumApiContext : DbContext {

        public museumApiContext() { }
    
                            
        public museumApiContext (DbContextOptions<museumApiContext> options)
            : base(options)
        {
        }
